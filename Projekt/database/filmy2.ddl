...
CREATE OR REPLACE TRIGGER delete_after_rating
AFTER INSERT OR UPDATE ON ocena_filmu
FOR EACH ROW
BEGIN
    DELETE FROM pozycja WHERE film_id = :NEW.film_id AND uzytkownik_id = :NEW.uzytkownik_id;
END;
/